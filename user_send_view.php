           ...
           <div class="profile_details_left">
             <ul class="nofitications-dropdown">
               <li class="dropdown note dra-down">
                 <div id="dd" class="wrapper-dropdown-3" tabindex="1"> <span>Italy</span>
                     <ul class="dropdown">
				   ...
				   $xyz1=mysql_query("select * from user_details where email='$dd'");
				    while($row1=mysql_fetch_array($xyz1))
					{
					 ...
					 $rname=$row1['name'];
					   ...
					   ?>
 <tr class="table-row">
                         <td width="47%" class="table-img"><p><img src="img/<?php echo $rimage;?>" alt="" height="50px" width="50px" /><span class="mar"><?php echo $dd;?>
