...
$xyz=mysql_query("select * from user_details where status='1'");
     ...
     <div class="inner-content">
       ...
       <div class="outter-wp">
         ...
         <div class="graph-visual tables-main">
           <h2 class="inner-tittle">Spamer Details</h2>
           <div class="graph">
             <div class="tables">
               <table class="table">
                 <thead>
...
{ 
				  ...
				  $xyz=mysql_query("select * from user_messages where status='1'"); 
...
?>
                     ...
                     <td><a href="athority_spam_details1.php?email=<?php echo $row['sender'];?>&id=<?php echo $row['id'];?>">Block</a></td>
                   </tr>
                   <?php
					   $a++;
					    }
